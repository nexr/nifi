...
public class FetchS3Object extends AbstractS3Processor {
    ...
    public static final List<PropertyDescriptor> properties = Collections.unmodifiableList(
            Arrays.asList(BUCKET, KEY, REGION, ACCESS_KEY, SECRET_KEY, CREDENTIALS_FILE, AWS_CREDENTIALS_PROVIDER_SERVICE, TIMEOUT,
                MAX_RETRY, RETRY_MODE, THROTTLE_RETRIES, TIME_TO_LIVE, MAX_IDLE_TIME, VERSION_ID,
